...
This Package is for XM/XM+ ACCST v2.1.0 firmware update.

Version and Files: 
XM+_ACCST_V2.1.0_FCC.frk                            Firmware under NonLbt mode which is certificated for FCC rules. 
XM+_ACCST_V2.1.0_LBT.frk                             Firmware under LBT mode which is certificated for CE rules.  
XM+_ACCST_V2.1.0_FCC-RSSI.frk                    Firmware under NonLbt mode which is certificated for FCC rules. ch16 in sbus is the RSSI output signal.
XM+_ACCST_V2.1.0_LBT-RSSI.frk                     Firmware under NonLbt mode which is certificated for LBT rules.  ch16 in sbus is the RSSI output signal.
...
https://www.frsky-rc.com/product/xm/
