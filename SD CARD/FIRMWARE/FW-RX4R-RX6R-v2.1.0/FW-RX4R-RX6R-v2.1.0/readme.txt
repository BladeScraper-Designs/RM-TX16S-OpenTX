...
This Package is for RX4R/RX6R ACCST v2.1.0 firmware update. 

Version and Files: 
RX6R_ACCST_V2.1.0_FCC.frk                              Firmware under NonLbt mode which is certificated for FCC rules. 
RX6R_ACCST_V2.1.0_LBT.frk                               Firmware under LBT mode which is certificated for CE rules.  
