...
This Package is for X4R/X4R SB ACCST v2.1.0 firmware update. 

Version and Files: 
X4R_ACCST_V2.1.0_FCC.frk                                  Firmware under NonLbt mode which is certificated for FCC rules. 
X4R_ACCST_V2.1.0_LBT.frk                                   Firmware under LBT mode which is certificated for CE rules.  
