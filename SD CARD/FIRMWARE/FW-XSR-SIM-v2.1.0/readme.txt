...
This Package is for XSR-SIM ACCST v2.1.0 firmware update. 

Version and Files: 
XSR-SIM_ACCST_V2.0.0_FCC.frk                                  Firmware under NonLbt mode which is certificated for FCC rules. 
XSR-SIM_ACCST_V2.1.0_LBT.frk                                   Firmware under LBT mode which is certificated for CE rules.  
